...
public final class MySwitchOutputWidget {
    ...
    public MySwitchOutputWidget(Scene scene, ShapeNode n) {
        ...
        switchOutputNodeProperties.setID(switchOutputNodeProperties.getNumber());
...
//                         
    ...
    private class LabelTextFieldEditor implements TextFieldInplaceEditor {
        ...
        public String getText(Widget widget) {
            ...
            return MySwitchOutputWidget.this.getSwitchOutputNodeProperties().getNumber()+"";
        ...
        public void setText(Widget widget, String text) {
            ...
            try
            {
                ...
                MySwitchOutputWidget.this.getSwitchOutputNodeProperties().setNumber(newNumber);
